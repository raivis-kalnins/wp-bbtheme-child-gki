...
</div><!-- /wp:group --></div><!-- /wp:group --><!-- wp:html --><div class="gki-testimonial-footer"><div class="gki-slider-menu" aria-label="Testimonials slider menu"></div><button type="button" class="gki-add-testimonial" data-gki-testimonial-open aria-haspopup="dialog" aria-controls="gki-testimonial-modal">Add Testimonial</button></div><!-- /wp:html --></div><!-- /wp:column -->
